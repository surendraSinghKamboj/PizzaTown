...
fun Order.toDto() = OrderDto(
    ...
    customer = OrderCustomerDto(customer.name, customer.phone, customer.address),
    items = items.map { OrderLineItemDto(it.menuItemId, it.name, it.variantName, it.customizationNames, it.quantity, it.unitPrice, it.lineTotal) },
